  ...
  return (
    <div className="flex flex-col h-full overflow-hidden stagger-container pb-6">
      ...
      <div className="text-center pt-2 pb-2 shrink-0 mb-4">
        ...
        <p className="text-zinc-400 text-md px-6">
      ...
      <div className="mx-5 my-auto bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shrink-0 shadow-sm relative overflow-hidden">
        ...
        <div className="flex justify-between items-center pb-5 mb-5 border-b border-dashed border-zinc-700">
          <div className="text-left">
            <p className="text-sm text-zinc-500 font-bold font-unbounded mb-1">Fecha</p>
            <p className="font-semibold text-white text-md capitalize">
              {booking.date && format(booking.date, 'EEEE d MMM.', { locale: es })}
            </p>
          </div>
          <div className="text-right">
            <p className="text-sm text-zinc-500 font-bold font-unbounded mb-1">Hora</p>
            <p className="font-semibold text-white text-md">{booking.time}</p>
          </div>
        </div>

        <div className="flex justify-between items-end gap-4">
          <div className="text-left overflow-hidden flex-1">
            <p className="text-sm text-zinc-500 font-bold font-unbounded mb-1">Cliente</p>
            <p className="font-medium text-white text-md truncate capitalize">
      ...
      <div className="mt-8 px-5">
        <Link
          ...
          onClick={onClose}
          className="w-full group bg-yellow-500 text-zinc-950 py-3.5 rounded-xl font-bold hover:opacity-90 transition-opacity flex items-center justify-center gap-2 shadow-md text-md font-unbounded"
        >
