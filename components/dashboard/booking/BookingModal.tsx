          ...
          <div className="p-4 border-b border-zinc-800 bg-zinc-900/50 backdrop-blur-md sticky top-0 z-10 flex justify-between items-center shrink-0">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <h3 className='text-lg text-white font-bold leading-tight font-unbounded'>Agendar Cita</h3>
        ...
        {step < 6 && (
          <div className="p-4 border-t border-zinc-800 bg-zinc-950 sticky bottom-0 z-10 shrink-0">
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex flex-col">
                <span className="text-xs font-unbounded text-zinc-500 font-bold">Total estimado</span>
              ...
              <button
                ...
                className={cn(
                  "flex-1 max-w-[200px] py-3.5 px-6 rounded-xl font-bold text-md flex items-center justify-center gap-2 transition-all duration-300 font-unbounded",
