                            ...
                            <div className="flex flex-col sm:flex-row gap-6">
                                <div className="flex-1 space-y-2">
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3 text-white focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500 outline-none transition-all"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input 
                                            ...
                                            className="w-full bg-zinc-900 border border-zinc-800 rounded-xl pl-10 pr-4 py-3 text-white focus:border-yellow-500 outline-none transition-all"
                                            placeholder="0.00"
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3 text-white focus:border-yellow-500 outline-none text-sm"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea 
                                        ...
                                        className="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3 text-white focus:border-yellow-500 outline-none text-sm min-h-[100px] resize-none"
