  ...
  return (
    <section className="relative z-10 w-full py-24 md:py-32 border-t border-white/[0.02] bg-[#09090b] overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10 flex flex-col items-center text-center">
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold font-unbounded text-white mb-6 leading-tight">Es hora de ser el dueño <br/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 to-yellow-600">de tu propio éxito.</span></h2>
        ...
        <Link href="/register" className="inline-flex items-center justify-center gap-2 bg-yellow-500 hover:bg-yellow-400 text-black font-bold px-10 py-5 rounded-2xl transition-all duration-300 hover:shadow-[0_0_40px_rgba(234,179,8,0.4)] hover:-translate-y-1 text-lg group">
