  ...
  return (
    <section className="relative z-10 w-full py-24 md:py-32 border-t border-white/[0.02] bg-[#09090b] overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10 flex flex-col items-center text-center">
        <h2 className="text-5xl lg:text-6xl font-extrabold leading-[0.90] tracking-tighter mt-4 mb-6 font-unbounded">Es hora de ser el dueño <br/> <span className="text-transparent bg-clip-text bg-linear-to-r from-yellow-300 to-yellow-500">de tu propio éxito.</span></h2>
        ...
        <Link href="/register" className="inline-flex items-center justify-center gap-2 bg-yellow-500 hover:bg-yellow-400 text-black font-bold px-10 py-4 rounded-full transition-all duration-300 shadow-[0_0_30px_rgba(234,179,8,0.4)] hover:shadow-[0_0_30px_rgba(234,179,8,0.6)] hover:-translate-y-1 text-lg group">
