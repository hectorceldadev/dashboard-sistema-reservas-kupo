            ...
            <div className="bg-zinc-900 border border-zinc-800 w-full max-w-sm rounded-[2rem] shadow-2xl relative z-10 overflow-hidden flex flex-col max-h-[90vh] duration-200 stagger-container">
                ...
                <div className="py-4 px-6 relative flex flex-col items-center justify-center shrink-0 border-b border-zinc-800 bg-zinc-950/50">
                    ...
                    <div className="text-center z-10 space-y-2">
                        <h2 className="font-bold text-md text-white font-unbounded">{booking.customer_name}</h2>
                        <span className={`inline-block px-3 py-1 rounded-full text-xs font-unbounded font-bold border ${currentStatus.color}`}>
                            {currentStatus.label}
                        </span>
                    </div>
                ...
                <div className="p-6 overflow-y-auto custom-scrollbar space-y-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-4 p-4 bg-zinc-950 border border-zinc-800/80 rounded-2xl">
                            ...
                            <div>
                                ...
                                <p className="font-bold font-unbounded text-sm text-zinc-200">
                    ...
                    <div className="p-5 bg-zinc-950 border border-zinc-800/80 rounded-2xl">
                        ...
                        <div className="flex justify-between items-center mt-4 pt-4 border-t border-zinc-800">
                            <p className="font-bold text-zinc-400 text-sm font-unbounded flex items-center gap-1.5">
                ...
                <div className="p-4 border-t border-zinc-800 bg-zinc-900 shrink-0">
                    ...
                    {isCancellable ? (
                        ...
                        <button
                            onClick={onClose}
                            className="w-full py-3 rounded-xl font-bold font-unbounded text-sm text-zinc-900 bg-yellow-500 hover:bg-yellow-500/70 transition-colors cursor-pointer"
                        >
                            Cerrar
                        </button>
                    )}
