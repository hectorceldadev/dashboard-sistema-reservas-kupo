            ...
            <div className="bg-zinc-900 border border-zinc-800 w-full max-w-sm rounded-[2rem] shadow-2xl relative z-10 overflow-hidden flex flex-col max-h-[90vh] animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="py-4 px-6 relative flex flex-col items-center justify-center shrink-0 border-b border-zinc-800 bg-zinc-950/50">
                    ...
                    <div className="text-center z-10 space-y-2">
                        <h2 className="font-bold text-lg text-white leading-tight">{booking.customer_name}</h2>
                        <span className={`inline-block px-3 py-1 rounded-full text-xs font-bold border uppercase tracking-wider ${currentStatus.color}`}>
                            {currentStatus.label}
                        </span>
                    </div>
                ...
                <div className="p-6 overflow-y-auto custom-scrollbar space-y-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-4 p-4 bg-zinc-950 border border-zinc-800/80 rounded-2xl">
                            ...
                            <div>
                                <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider mb-0.5">Profesional</p>
                    ...
                    <div className="p-5 bg-zinc-950 border border-zinc-800/80 rounded-2xl">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <p className="text-xs text-zinc-400 font-bold uppercase tracking-wider">Servicios Contratados</p>
                        </div>
                        ...
                        <div className="flex justify-between items-center mt-4 pt-4 border-t border-zinc-800">
                            <p className="font-bold text-zinc-400 text-sm flex items-center gap-1.5">
